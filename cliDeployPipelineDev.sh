...
aws cloudformation deploy --template-file lbstInfra.yaml --capabilities CAPABILITY_IAM --parameter-overrides ParentVPCStack=ictdevawsvpc Application=lbst BranchName=${BranchName} --stack-name ${StackName}
