...
rm -fr ./build
sam deploy --template-file packaged.yaml --parameter-overrides Environment=C Application=lbst LabStatsAPIKey=$LABSTATS_API_KEY --capabilities CAPABILITY_IAM --stack-name lbstSyncFunc
rm packaged.yaml